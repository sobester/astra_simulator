...
The job of the simulator manager is to collect all the input parameters, set up
the necessary objects for the simulation according to the flight type (standard
or floating), initialize all the objects correctly and run the simulation.
...
Arguments are:
    ...
    -t [date and time], required.  NOTE: Format should be exactly 'dd/mm/yyyy
        HH:mm', at the launch site's local time.
